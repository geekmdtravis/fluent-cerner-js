 ...
 * @param {number} targetId - For a new form, this is the formId (pulled from DCP_FORMS_REF_ID). For a completed form, this is the activityId (pulled from DCP_FORMS_ACTIVITY_ID). This parameter is required only for `new form` or `completed form` targets.
